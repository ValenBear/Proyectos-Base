...
import { loginSuccess, logout } from "../../redux/autorizacion/slice";
import { gesturesController } from "@brunomon/template-lit/src/views/controllers/gesturesController";
import { selection, showConfirm } from "../../redux/ui/slice";
import { set } from "../../redux/miPerfil/slice";
    ...
    render() {
        return html`
            ...
            <div id="opciones" class="grid column" @click=${this.toggleMenu}>
                ...
                <button link ?selected="${this.selectedOption[0]}" @click=${this.click} .option=${"abm"}>ABM Test</button>
