...
namespace OSPeConTI.SumariosIERIC.Application
{
    ...
    static class CustomExtensionsMethods
    {
        ...
        )
        {
            services
                .AddDbContext<SumariosContext>(opt =>
                    opt.ConfigureWarnings(warnings => warnings.Ignore(CoreEventId.NavigationBaseIncludeIgnored))
                        .UseInMemoryDatabase("SumariosIERIC"));
            ...
            services.AddScoped<OSPeConTI.SumariosIERIC.Domain.Entities.IEmpresaRepository, OSPeConTI.SumariosIERIC.Infrastructure.Repositories.EmpresaRepository>();
       ...
       .AddTransient(typeof(
        ...
        )
        {
            services
                ...
                {
                    options.UseInMemoryDatabase("IntegrationEventLog");
                });
            return services;
        }
